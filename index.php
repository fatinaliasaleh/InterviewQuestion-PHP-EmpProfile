        ...
        <div class="container">
            ...
            <div class="card shadow">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a data-target-url="add_update.php" class="btn_add_employee btn btn-success">
                            <i class="plus"></i> New Member
                        </a>
                    </div>
                </div>
                <div class="card-body">
        ...
        if (employees) {
            $.each(employees, function(index, employee) {
                html += `<tr>` +
                    ...
                    `<td class="stick_column"><a data-target-url="add_update.php?id=` + employee.id + `" class="btn btn-warning btn_edit_employee">Edit</a>
